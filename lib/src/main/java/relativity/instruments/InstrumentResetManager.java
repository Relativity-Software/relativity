...
public class InstrumentResetManager {

    public void scheduleResets(InstrumentManager instrumentManager, ThreadPool pool) {
        pool.scheduleAtFixedRate(
            () -> instrumentManager.resetPricingAndStatisticsAll(),
        0,
        1000,
            TimeUnit.MINUTES
        );
